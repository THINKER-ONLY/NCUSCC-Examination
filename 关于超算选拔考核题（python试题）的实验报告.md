...
![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-17 193609.png)

​        然后在扩展这一栏，我们搜索Python，选择第一个进行instill即可。

![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-14 101918.png)

​        完成后新建一个文件夹来存放我们的代码，这里我创建的文件夹名称为vscode。![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-14 102309.png)

​        最后在vscode中打开我们创建的文件夹。![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-14 102513.png)

​        再根据下图步骤进行必要的设置。![](C:\Users\李政阳\Desktop\新建文件夹\39acda2dab69e7aaecdf3a89069e4b38.png)

![](C:\Users\李政阳\Desktop\新建文件夹\b97aed9ca30d25a07afa20f5eab87396.png)
...
![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-12 192035.png)

​       平均用时14.1秒。

​       使用multiprocessing进行10000*10000矩阵的运算所用时间结果如下：![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-16 093422.png)
...
对于mpi4py：![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-16 093335.png)

其4进程的运行情况下，CPU占用接近100%，占用相当之高。内存使用情况相对而言没有特别高，有大量的空闲内存和缓存。交换空间完全没有被使用，这也表明系统没有因为内存不足而使用交换空间却运行程序。

对于multiprocessing：![](C:\Users\李政阳\Desktop\新建文件夹\屏幕截图 2024-10-16 093047.png)
...
汇总如图：![](C:\Users\李政阳\Desktop\新建文件夹\good.png)
...
- 使用不同矩阵大小，来比较计算量变化对计算时间的影响。
  ...
  对于mpi4py，如图：![](C:\Users\李政阳\Desktop\新建文件夹\re.png)

  对于multiprocessing，如图：![](C:\Users\李政阳\Desktop\新建文件夹\tired.png)
...
![](C:\Users\李政阳\Desktop\新建文件夹\scipy1.png)
...
![](C:\Users\李政阳\Desktop\新建文件夹\new0.png)

​       对于CPU的使用，我把图片拼接在了一起，方便进行对比。（排序为：左上2进程，右上4进程，左下8进程，右下16进程）![](C:\Users\李政阳\Desktop\新建文件夹\拼接.png)

​       可以看出在2进程时CPU的使用率是最高的。所以2进程有着更快地处理速度和最短的完成时间。而对于CPU的使用率，除2进程外不同进程基本持平，而运算速度越快，CPU的占用越高。对于内存，个进程均有着不低的内存占用，但内存的使用仍很健康，且只占用了一部分交换内存空间，没有因频繁使用交换空间造成性能下降。![](C:\Users\李政阳\Desktop\新建文件夹\CPU占用问题.png)
...
- 对于multiprocessing，其运行速度在进程数较小时远不及mpi4py。如下图：![](C:\Users\李政阳\Desktop\新建文件夹\666.png)

​          multiprocessing的各进程CPU占用如图。（排序为：左上2进程，右上4进程，左下8进程，右下16进程）

![](C:\Users\李政阳\Desktop\新建文件夹\拼接-1729094466341-6.png)
...
![](C:/Users/%E6%9D%8E%E6%94%BF%E9%98%B3/Desktop/%E6%96%B0%E5%BB%BA%E6%96%87%E4%BB%B6%E5%A4%B9/10086.png)

![](C:\Users\李政阳\Desktop\新建文件夹\333.png)
